...
<div class="navbar">
		 ...
		 <br><br><br>
		<h3 style="padding-left: 580px;" > DELETE FEEDBACK </h3>
		<div class = 'content'>
...
<?php
	...
	$result = $con->query("SELECT * FROM feedbackinfo WHERE UserID = '$search_value'");
		...
		while($rows=$result->fetch_assoc()){
			...
			echo"<tr>" .
				"<td>" . $rows['UserID'] . "</td>" . 
		      	"<td>" . $rows['Name'] . "</td>" .
		      	"<td>" . $rows['Feedback'] . "</td>". 
		      	"<td>" ."<a href='DeleteFeedback1.php?op=$id'>" ."delete"."</a>" ."</td>";				
		}
	}
	else{
		echo"
